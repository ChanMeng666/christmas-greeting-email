...
<a href="https://sendjoy.chanmeng-dev.workers.dev/">
  <img src="docs/showcase/hero.webp" alt="SendJoy dashboard — 'WELCOME TO SENDJOY' heading with Setup Progress checklist (Configure API Key, Set Up Sender Info, Add Contacts, Send Your First Email) and quick-action cards for Templates, Contacts, Send Email, and Settings" width="100%">
</a>

![Demo: SendJoy welcome onboarding flow — modal explaining 3-step setup, then dashboard and template gallery with Classic Christmas, New Year 2025, Chinese New Year, Birthday Wishes, Product Launch, and Weekly Newsletter templates](docs/showcase/demo.gif)

<details>
<summary>🎨 Template gallery</summary>

<img src="docs/showcase/templates.webp" width="100%" alt="SendJoy Templates — grid of 6 email templates with category tabs (ALL 6, HOLIDAY 4, MARKETING 1, NEWSLETTER 1). Templates: Classic Christmas, New Year 2025, Chinese New Year, Birthday Wishes, Product Launch, Weekly Newsletter">
...
<img src="docs/showcase/mobile-hero.webp" width="390" alt="SendJoy on mobile — stacked 'WELCOME TO SENDJOY' heading with Setup Progress checklist and Templates quick-action card below">
